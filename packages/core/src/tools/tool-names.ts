...
export const BATCH_READ_FILES_DISPLAY_NAME = 'BatchReadFiles';
export const BATCH_SHELL_COMMANDS_DISPLAY_NAME = 'BatchShellCommands';
export const CRON_DISPLAY_NAME = 'CronManage';
